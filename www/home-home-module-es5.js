...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
  ...
  function srcAppHomeHomeModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _windowRef__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./windowRef */
  ...
  function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _save_treasure_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../save-treasure.service */
    "./src/app/save-treasure.service.ts");
    /* harmony import */


    var _windowRef__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./windowRef */
    "./src/app/home/windowRef.ts");
    /* harmony import */
    ...
    var HomePage = /*#__PURE__*/function () {
      function HomePage(windowRef, treasureService, tts) {
      ...
      _createClass(HomePage, [{
        ...
        value: function ngOnInit() {
          ...
          this.img.onload = function () {
            _this2.ctxMap.drawImage(_this2.img, 0, 0);

            _this2.drawDot(_this2.coords);
          };

          setInterval(function () {
            var x = _this2.coords[0] + _this2.speedX;
            var y = _this2.coords[1] + _this2.speedY;

            var imgData = _this2.ctxMap.getImageData(x, y, 1, 1).data;
            ...
            _this2.coords[0] = _this2.coords[0] + _this2.speedX;
            _this2.coords[1] = _this2.coords[1] + _this2.speedY;

            _this2.drawDot(_this2.coords);

            _this2.treasureService.setTreasureDistance(_this2.coords);
          }, 40);

          document.onkeyup = function (e) {
            _this2.ctxDot.fillStyle = "#ff2626";

            var newCoors = _toConsumableArray(_this2.coords);
            ...
            switch (e.keyCode) {
              // left
              case 37:
                newCoors[0] -= _this2.step;
                itIsArrow = true;
                break;
              //up

              case 38:
                newCoors[1] -= _this2.step;
                itIsArrow = true;
                break;
              // right
            ...
            if (itIsArrow) {
              var imgData = _this2.ctxMap.getImageData(newCoors[0], newCoors[1], 1, 1).data;
              ...
              _this2.coords = _toConsumableArray(newCoors);
        ...
        value: function showAlert() {
          ...
          setTimeout(function () {
            _this3.alertIsShow = false;
          }, 200);
        }
      }, {
        key: "drawDot",
        value: function drawDot(coords) {
        ...
        value: function getOrientation() {
          ...
          this.tts.speak('Hide the treasure');
          var audio1 = document.getElementById('music'); //@ts-ignore

          audio1.volume = 0.2; //@ts-ignore
            ...
            DeviceOrientationEvent.requestPermission().then(function (response) {
              if (response == 'granted') {
                window.addEventListener('deviceorientation', function (e) {
                  ...
                  window.addEventListener('deviceorientation', function (e) {
                    _this4.beta = e.beta;
                    _this4.gamma = e.gamma;
                    _this4.speedX = e.gamma / 3;
                    _this4.speedY = e.beta / 3;
                  });
                });
              }
            })["catch"](console.error);
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('canvas', {
      "static": true
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"])], HomePage.prototype, "canvasMain", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('dot', {
      "static": true
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"])], HomePage.prototype, "canvasDot", void 0);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_windowRef__WEBPACK_IMPORTED_MODULE_3__["WindowRef"], _save_treasure_service__WEBPACK_IMPORTED_MODULE_2__["SaveTreasureService"], _ionic_native_text_to_speech_ngx__WEBPACK_IMPORTED_MODULE_4__["TextToSpeech"]])], HomePage);
    /***/
  },
  ...
  /***/
  function srcAppHomeWindowRefTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSaveTreasureServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SaveTreasureService", function () {
      return SaveTreasureService;
    });
    /* harmony import */
    ...
    var SaveTreasureService = /*#__PURE__*/function () {
      function SaveTreasureService() {
        _classCallCheck(this, SaveTreasureService);

        this.coords = [0, 0];
        this.treasureIsBuried = false;
      }

      _createClass(SaveTreasureService, [{
        key: "setTreasureBuried",
        value: function setTreasureBuried(state) {
          this.treasureIsBuried = state;
        }
      }, {
        key: "setTeasureCoords",
        value: function setTeasureCoords(coords) {
          this.coords = _toConsumableArray(coords);
        }
      }, {
        key: "setTreasureDistance",
        value: function setTreasureDistance(coords) {
          this.distance = Math.round(Math.sqrt(Math.pow(coords[0] - this.coords[0], 2) + Math.pow(coords[1] - this.coords[1], 2)));
        }
      }, {
        key: "getTreasureCoords",
        get: function get() {
          return this.coords;
        }
      }]);
    ...
    SaveTreasureService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], SaveTreasureService);
    /***/
  }
